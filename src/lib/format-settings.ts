...
// style to TypeScript format settings. The write commands call this per file so each
...
// FormatStyle → the FormatCodeSettings refineFormat hands to TypeScript. The
