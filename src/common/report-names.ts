...
export const reportNames: readonly TSR.ReportName[] = ["semicolons", "indent", "member-delimiter", "new-line", "bracket-spacing", "trailing-comma"] as const
...
export const formatReportNames: readonly TSR.ReportName[] = ["semicolons", "indent", "member-delimiter", "new-line", "bracket-spacing", "trailing-comma"]
