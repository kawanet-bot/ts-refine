...
export function usage(): string {
    ...
    return [
        ...
        "  --function-keyword-spacing <on|off>",
        "                              Override function keyword spacing",
        "  --function-paren-spacing <on|off>",
        "                              Override function paren spacing",
        "  --control-keyword-spacing <on|off>",
        "                              Override control keyword spacing",
        "  --check                     Report only; exit non-zero if any file would change",
        "",
